...
class ResUNet(nn.Module):
    ...
    def __init__(self, base_ch=64, dino_embed_dim=768):
        ...
        self.bottleneck_in = nn.Conv2d(base_ch*8 + dino_embed_dim, base_ch*8, 1, bias=False)
    ...
    def forward(self, x, dino_feat_map):
        ...
        x = self.bottleneck_in(torch.cat([x, dino_feat_map], dim=1))
        x = self.bottleneck(x)
